        ...
        {!loading && (
          ...
          >
            ...
            <div aria-hidden className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
              ...
              <div className="ambient-orb ambient-orb-gold animate-orb-drift w-[420px] h-[420px] top-1/3 -right-32" style={{ animationDelay: "-7s" }} />
              <div className="ambient-orb ambient-orb-copper animate-orb-drift w-[520px] h-[520px] bottom-0 left-1/4" style={{ animationDelay: "-12s" }} />
